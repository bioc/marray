...
tmp<-image(swirl[,3], xvar="maM", subset=maTop(maM(swirl[,3]), h=0.10, l=0.10), col=RGcol, contours=FALSE, bar=FALSE,main="Swirl array 93: image of pre--normalization M for \% 10 tails") 
@
...
boxplot(swirl[,3], xvar="maPrintTip", y="maM", main="Swirl array 93: pre--normalization") 
@
